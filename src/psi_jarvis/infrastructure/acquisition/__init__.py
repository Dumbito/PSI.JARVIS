from psi_jarvis.infrastructure.acquisition.bootstrap import (
    build_default_bibliographic_registry,
)
from psi_jarvis.infrastructure.acquisition.pubmed import (
    PubMedAdapter,
    PubMedXmlMapper,
...
from psi_jarvis.infrastructure.acquisition.scopus import (
    ScopusAdapter,
    ScopusJsonMapper,
...
from psi_jarvis.infrastructure.acquisition.wos import (
    WebOfScienceAdapter,
...
from psi_jarvis.infrastructure.acquisition.zotero import (
    ZoteroAdapter,
    ZoteroJsonMapper,
